...
# Change directory to the cvmfs_extension directory
...
jupyter server extension disable cvmfs_extension
...
folder is located. Then you can remove the symlink named `cvmfs_extension` within that folder.
...
```sh
pytest -vv -r ap --cov cvmfs_extension
```
